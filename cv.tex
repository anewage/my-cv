...
\begin{tabular}{r|p{14.70cm}}	
    \textsc{Current} & Master of Science Degree in \textsc{Computer Science} \\
    \textsc{2018} & \normalsize\textbf{University of Western Ontario}, London\\
    ...
    \textsc{2018} & Undergraduate Degree in \textsc{Computer Engineering} \\
    \textsc{2014} & \normalsize\textbf{Amirkabir Univesity of Technology (Tehran Polytechnic)}, Tehran\\
    ...
    \hyperlink{grds_usc}{\hfill \footnotesize Detailed List of Scores and courseworks}\\
    & \textsc{CGPA} (overall): 16.65/20.00 (3.33/4.00)\\\multicolumn{2}{c}{}\\
    
    \textsc{2014} & High School Diploma in \textsc{Math \& Physics} \\
    \textsc{2010} & \textbf{National Organization for Development of Exceptional Talents (NODET)}, Maragheh (Shahid Beheshti Highschool)\\
...
\begin{itemize}
    \item User-centered Design and User-driven Development
    \inlineitem Crowdsourcing and Crowdsourced Problem Solving
    \inlineitem Information Visualization
    \inlineitem Human-Computer Interaction
    \inlineitem Software, UI/UX and Web Usability Testing
    \inlineitem Progressive Web Applications
    \inlineitem Cross-Platform Applications \\
\end{itemize}
...
\begin{tabular}{rl}
    ...
    %& TOEFL iBT Score: 98 - \emph{Reading: 25}, \emph{Listening: 22}, \emph{Speaking: 24}, \emph{Writing: 27}\\
